...
const Template = (props) => {
  ...
  const spanCss = cs([
    ...
    'fi-switch__container--' + effect
  ]);

  const inputCss = cs([
    'fi-switch__input',
    'fi-switch__input--' + effect
  ]);

  const styleCss = cs([
    'fi-switch__style',
    'fi-switch__style--' + effect
  ]);
  const styleCssExtra = cs([
    'fi-switch__extra',
    'fi-switch__extra--' + effect
  ]);
  return (
    <span className={spanCss}>
      <input onBlur={onBlur} ref={setRef} onChange={onChange} onFocus={onFocus} className={inputCss} checked={checked} type="checkbox" id={htmlFor} {...otherProps}/>
      {children}
    </span>
  );
}
...
const skeleton = (props) => {
  ...
  return (
    <Template effect={effect} {...props}>
      ...
      <span className='fi-skeleton__handle--container '>
...
const lima = (props) => {
  ...
  return (
    <Template effect={effect} {...props}>
      <span className='fi-lima__track'/>
      <svg className="fi-lima__check" version="1.1" viewBox="0 0 100 100" x="0px" xmlns="http://www.w3.org/2000/svg" y="0px">
      ...
      <span className='fi-lima__handle--container '>
        <span className='fi-lima__handle--border'/>
        <span className='fi-lima__handle'/>
      </span>
    </Template>
  )
...
const charlie = (props) => {
  ...
  return (
    <Template effect={effect} {...props}>
      ...
      <span className="fi-charlie__text--on" aria-hidden='true' role="presentation" tabindex="-1">ON</span>
      <span className="fi-charlie__text--off" aria-hidden='true' role="presentation" tabindex="-1">OFF</span>
    </Template>
  )
}
...
const foxtrot = (props) => {
  ...
  return (
    <Template effect={effect} {...props}>
      ...
      <span className="fi-foxtrot__text fi-foxtrot__text--on" aria-hidden='true' role="presentation" tabindex="-1">ON</span>
      <span className=" fi-foxtrot__text fi-foxtrot__text--off" role="presentation" tabindex="-1">OFF</span>
