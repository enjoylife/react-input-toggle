...
const Template = (props) => {
  ...
  const {
    effectName, htmlFor, onBlur, onFocus, onChange, checked, setRef, children, ...otherProps
  } = props;
...
export default {b2spirit, simplygreen, bbounce, ios6, neonpush, sierra, charlie, echo, foxtrot}
