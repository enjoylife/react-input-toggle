...
class FancySwitch extends React.Component {
  ...
  render () {
    ...
    const outerCss = cs('fi-switch', 'fi-switch--' + effect, 'fi-switch--label-' + labelPosition, isFocused == true && !disabled && 'fi-switch--focused', checked == true && 'fi-switch--checked', disabled == true && 'fi-switch--disabled');
