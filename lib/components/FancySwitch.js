...
class FancySwitch extends React.Component {
  ...
  constructor (props) {
    ...
    this.componentWillMount = () => {
      this.setState({fiChecked: this.props.defaultChecked});
    }
  ...
  render () {
    ...
    let effectName = this.props.effectName;
    ...
    console.error('The effect "' + effectName + '" was not found. Use default instead')
      effectName = 'b2spirit'

    }
    const switchProps = {
      htmlFor, onBlur: this.onBlur, onFocus: this.onFocus, onChange: this.onChange, checked
    }
